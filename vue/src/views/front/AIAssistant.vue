        ...
        <el-col :span="8">
          <el-card class="intro-card" shadow="never">
            ...
            <ul class="feature-list">
              ...
              <li><span class="dot"></span>停车费标准？</li>
        ...
        <el-col :span="16">
          <el-card class="chat-card" shadow="never">
            <div class="chat-header">
              ...
              <span class="chat-subtitle">可以试着问：物业费怎么交？停车费标准是多少？怎么报修？</span>
            </div>
  ...
  data() {
    return {
      ...
      messages: [
        {
          role: 'assistant',
          content: '您好，我是小区 AI 助手，可以帮您解答物业费、停车费、报修流程、小区活动等常见问题，有什么想咨询的？'
        }
      ],
      faqList: [
        {
        ...
        {
          keywords: ['停车费', '停车', '车位', '收费标准', '停车费标准'],
          answer:
            '小区停车收费标准如下：<br/>' +
            '1）<b>固定车位月租</b>：地上车位 200 元/月，地下车位 300 元/月；<br/>' +
            '2）<b>临时停车</b>：前 30 分钟免费，之后 3 元/小时，单日封顶 20 元；<br/>' +
            '3）如有最新调整，以物业公告为准，可在“停车服务”中查看。'
        },
        {
  ...
  methods: {
    ...
    findAnswer(text) {
      ...
      return (
        ...
        '<br/>您也可以尝试换一种问法，例如：“物业费怎么交？ / 停车费标准是多少？ / 报修在哪里提交？”。'
      )
    },
    scrollToBottom() {
