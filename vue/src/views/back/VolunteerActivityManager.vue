    ...
    <div class="wrapper">
        <div class="page-header">
            <div class="header-content">
                ...
                <p class="subtitle">Volunteer Activity Management</p>
            </div>
        </div>
    ...
    methods: {
        ...
        handleDelete(row) {
            this.$confirm('此操作将删除该活动, 是否继续?', '提示', {
                ...
                Request.delete("/volunteer-activity/" + row.id).then(response => {
                    if (response.code === '0') {
                        this.$message({
                            type: 'success',
                            message: '删除成功!'
        ...
        batchDelete() {
            ...
            this.$confirm('此操作将删除选中活动, 是否继续?', '提示', {
                ...
                Request.delete('/volunteer-activity/batch', {
        ...
        fetchData({ page, limit } = {}) {
            ...
            Request.get("/volunteer-activity/page", { params }).then(response => {
                if (response.code === '0') {
        ...
        handleSave(formName) {
            this.$refs[formName].validate(valid => {
                ...
                const request = this.dialogForm.id 
                    ? Request.put("/volunteer-activity", data)
                    : Request.post("/volunteer-activity", data)
