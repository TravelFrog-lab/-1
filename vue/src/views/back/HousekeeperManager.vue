    ...
    <div class="wrapper">
        ...
        <div class="page-header">
            <div class="header-content">
                ...
                <p class="subtitle">Housekeeper Management</p>
            </div>
        </div>
    ...
    methods: {
        ...
        exportTable(type) {
            if (this.tableData.length) {
                const params = {
                    header: ['ID', '姓名', '手机号', '身份证号', '工作年限', '评分', '状态', '个人描述', '创建时间'],
                    key: ['id', 'name', 'phone', 'idCard', 'workYears', 'rating', 'status', 'description', 'createdAt'],
                    data: this.tableData,
                    autoWidth: true,
                    fileName: '家政人员信息表',
                    bookType: type
