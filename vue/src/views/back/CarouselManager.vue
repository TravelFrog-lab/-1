        ...
        <el-card class="menu-card" shadow="never">
            ...
            <el-form :inline="true" :model="listQuery" class="search-form">
                <el-form-item label="标题">
                    <el-input v-model="listQuery.title" placeholder="请输入标题" size="medium" clearable />
                </el-form-item>
                <el-form-item label="标签">
                    <el-input v-model="listQuery.tag" placeholder="请输入标签" size="medium" clearable />
                </el-form-item>
                <el-form-item>
                    <el-button type="primary" size="medium" plain icon="el-icon-search" @click="onSearch">查询</el-button>
...
export default {
    ...
    data() {
        return {
            ...
            // 查询列表参数（与后端 /carousels/page 的 pageNum、pageSize、title、tag 一致）
            listQuery: {
                currentPage: 1,
                pageSize: 10,
                title: undefined,
        ...
        cropImage() {
            this.$refs.cropper.getCropData(data => {
                ...
                Request.post('/file/upload/img', formData).then(res => {
                    if (res.code === '0') {
                        const path = typeof res.data === 'string' ? res.data : (res.data && (res.data.path || res.data.url)) || ''
                        this.dialogForm.imageUrl = path
