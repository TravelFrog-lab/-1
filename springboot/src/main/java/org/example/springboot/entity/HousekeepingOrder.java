...
public class HousekeepingOrder {
    ...
    @Schema(description = "订单状态: PENDING-待接单, CONFIRMED-已接单(待支付), IN_PROGRESS-进行中(已付), COMPLETED-已完成, CANCELLED-已取消")
    ...
    @Schema(description = "业主评价星级 1-5")
    @TableField("evaluation_rating")
    private Integer evaluationRating;

    @Schema(description = "业主评价内容")
